  ...
  return (
    <div className="mt-96">
      <div className="footer-main-div relative  ">
        <div className='light-border rounded-3xl footer-child-div w-4/5 absolute -top-1/2 left-1/2 transform -translate-x-1/2 translate-y-24 "  '>
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2  ">
            ...
            <p className="-translate-x-6 text-white text-center end-text text-2xl">
